"""Run every Part 2 script, in order.
...
PART_DIR = Path(__file__).resolve().parent / "part2"
SCRIPTS = (
    "design_lead_lag.py",
...
def main() -> int:
    print(f"Part 2: running {len(SCRIPTS)} scripts\n")
    failures: list[str] = []
    ...
    if failures:
        ...
        return 1
    print("  All scripts ran. Plots are in outputs/part2/.")
    return 0
