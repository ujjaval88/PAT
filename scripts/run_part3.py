"""Run every Part 3 script, in order.
...
PART_DIR = Path(__file__).resolve().parent / "part3"
SCRIPTS = (
    "characterize_timing.py",
    "evaluate_sensors.py",
    "evaluate_fusion.py",
    "design_fused_loop.py",
    "evaluate_closed_loop.py",
)


def main() -> int:
    print(f"Part 3: running {len(SCRIPTS)} scripts\n")
    failures: list[str] = []
    ...
    if failures:
        ...
        return 1
    print("  All scripts ran. Plots are in outputs/part3/.")
    return 0
